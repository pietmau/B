...
public class CheckoutTests extends ActivityInstrumentationTestCase2<NavigationView> {
    private Solo solo;
    ...
    public void testGbpTotal() throws InterruptedException {
        ...
        assertEquals(result, expected);
        // litmus
        assertTrue(!result.equalsIgnoreCase("0.95"));
    }
