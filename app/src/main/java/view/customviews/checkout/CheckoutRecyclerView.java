 ...
 */
public class CheckoutRecyclerView extends RecyclerView {
    private ArrayList<ShoppingItem> items;
    private String symbol;
    private String rate;

    public CheckoutRecyclerView(Context context) {
        super(context);
        init();
    }

    public CheckoutRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CheckoutRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        if (items != null) {
            ...
            setAdapter(checkoutAdapter);
            if (symbol != null && rate != null) {
                checkoutAdapter.setCurrency(symbol, rate);
            }
        }
    }
    ...
    public void setCurrency(Currency rate) {
        if (rate == null) {
            this.rate = null;
            this.symbol = null;
        } else {
